...
session_start();
$_SESSION['usuario'] = $usuario;
header('Location:http://www.pimedelio.com/PaginasAdministradores/PaginaAdministradores.php');
      ...
      <tr>
        ...
        <td>
        	...
        	if(isset($_POST['crear_cuenta'])){
    					...
    					session_destroy();
    					header('Location:http://www.pimedelio.com/paginasproyecto/crear_cuenta.php');
